  ...
  return (
    <div className="dashboard-layout animated-fade-in">
      ...
      <main className="main-content">
        ...
        >
          Real-time overview of visitor activity and system analytics.
        </p>
        ...
        <div className="stats-grid">
          ...
          <div className="glass-panel stat-card">
            ...
            <div className="value">{stats?.totalPasses || 0}</div>
          </div>
        ...
        <div className="glass-panel stat-card">
          <span className="label">Approved Appointments</span>
          <div
            className="value"
            style={{
              color: "var(--success)",
        ...
        <div className="glass-panel stat-card">
          <span className="label">Rejected Appointments</span>
          <div
            className="value"
            style={{
              color: "var(--danger)",
        ...
        <div className="glass-panel stat-card">
          <span className="label">Pending Appointments</span>
                ...
                >
                  ...
                  <div
                    style={{
                      width: "32px",
                      height: `${Math.max(
                        item.count > 0 ? heightPercentage : 4,
                        4,
                      )}px`,
                      background:
